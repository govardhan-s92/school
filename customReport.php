				...
				<div class="accordion-style1 panel-group" id="accordion">
											<div class="panel panel-default">
												<div class="panel-heading">
													<h4 class="panel-title">
														<a href="#collapseOne" data-parent="#accordion" data-toggle="collapse" class="accordion-toggle">
															...
															Select Details (Click to Expand...)
														</a>
													</h4>
												</div>
												...
												<div class="checkbox col-sm-3">
													<label>
														<input type="checkbox" class="ace" name="form-field-checkbox">
														<span class="lbl"> ModeofTransport</span>
													</label>
												</div>
												...
												<div class="checkbox col-sm-3">
													<label>
														<input type="checkbox" class="ace ace-checkbox-2" name="form-field-checkbox">
														<span class="lbl">  Father Qualification</span>
													</label>
												</div>
												<div class="checkbox col-sm-3">
													<label>
														<input type="checkbox" class="ace" name="form-field-checkbox">
														<span class="lbl"> Father Work</span>
													</label>
												</div>
												...
												<div class="checkbox col-sm-3">
													<label>
														<input type="checkbox" class="ace" name="form-field-checkbox">
														<span class="lbl"> Father Occupation</span>
													</label>
												</div>
												...
												<div class="checkbox col-sm-3">
													<label>
														<input type="checkbox" class="ace ace-checkbox-2" name="form-field-checkbox">
														<span class="lbl">  Father Annual Income </span>
													</label>
												</div>
												<div class="checkbox col-sm-3">
													<label>
														<input type="checkbox" class="ace" name="form-field-checkbox">
														<span class="lbl">  Father Off Address</span>
													</label>
												</div>
												...
												<div class="checkbox col-sm-3">
													<label>
														<input type="checkbox" class="ace" name="form-field-checkbox">
														<span class="lbl"> Father Office Phone</span>
													</label>
												</div>
