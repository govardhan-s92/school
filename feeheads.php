			...
			<div class="main-content">
				...
				<div class="row">
							  ...
							  <div class="row">
                               ...
                               <div style="display:none;" id="a" class="modal fade" tabindex="-1">
...
var fetch = angular.module('myApp', []);
        ...
        fetch.controller('dbCtrl', ['$scope', '$http', function ($scope, $http) {
			...
			$scope.loadData = function() {
			 $http.get("ajax/selectData/viewfeeHead.php")
		...
		//$scope.user = {};
			$scope.creatfee = function() {
				...
				$http({
          method  : 'POST',
          url     : 'ajax/insertData/creatfeeHead.php',
