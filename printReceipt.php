		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
				...
				<div class="row">
                  ...
                  <?php
				$abslist = "SELECT *, student_info1.CLASSSEC, feesreceipt.ReceiptID, feesreceipt.period, feesreceipt.rec_date FROM v_studentlist LEFT JOIN student_info1 ON v_studentlist.ADMISSION_ID = student_info1.ADMISSION_ID LEFT JOIN feesreceipt ON v_studentlist.ADMISSION_ID = feesreceipt.ADMISSION_ID WHERE feesreceipt.ReceiptID != 'NULL' ORDER BY ReceiptID DESC LIMIT 5";			
				...
				<td><b>Initial</b></td>
				<td><b>Paid Date & Time</b></td>
				<td><b>Print</b></td>
				</tr>";
				$absnum = mysql_num_rows($abslistexe);
				
				if($absnum >0){
					$i=1;
					while($abslistarr = mysql_fetch_array($abslistexe)){
						$ReceiptID = $abslistarr['ReceiptID'];
						$ADMISSION_ID = $abslistarr['ADMISSION_ID'];
						$grp = $abslistarr['grp'];
						$Standard = $abslistarr['Standard'];
						$Section = $abslistarr['Section'];
						$CLASSSEC = $abslistarr['CLASSSEC'];
						$CLASS_ID = $abslistarr['CLASS_ID'];
						$NAME=$abslistarr['NAME'];
						$FATHER_NAME=$abslistarr['FATHER_NAME'];
						$Type=$abslistarr['Type'];
						$rec_date = $abslistarr['rec_date'];
						$phone = $abslistarr['phone'];
						$studentName=''.$NAME." ".$FATHER_NAME;				
						echo "<tr>";
						echo "<td>$ReceiptID</td>";
						echo "<td>$ADMISSION_ID</td>";
						echo "<td>$Standard - $Section</td>";
						echo "<td>$Type</td>";
						echo "<td>$NAME</td>";
						echo "<td>$FATHER_NAME</td>";
						echo "<td>$rec_date</td>";
						echo "<td><a href='form/printFiles/".$CLASSSEC."".$Type.".php?send=$ADMISSION_ID&grp=$grp&ReceiptID=$ReceiptID&CLASS_ID=$Standard - $Section&NAME=$NAME&FATHER_NAME=$FATHER_NAME&AI=$Type' target='_blank'>Print Receipt</a></td>";
						$i= $i+1;
					}
					echo "</form></table>";
					...
					echo "<tr><td colspan='7' align='center'><b>No Results</b></td></tr></form></table>";
				}
